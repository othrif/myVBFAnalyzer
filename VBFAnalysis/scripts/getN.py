...
parser.add_argument( "-o", "--output", type = str, dest = "output", default = os.path.expandvars("${SourceArea}/VBFAnalysis/data/f_norm.root"), help = "output file name" )
    ...
    for fdir in fdir_list:
        ...
        while returnCode!=None:
            if args.grid:
                ...
                print fdir.strip("\n")+"/*"
                p = subprocess.Popen("ls "+fdir.strip("\n")+"/*", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
