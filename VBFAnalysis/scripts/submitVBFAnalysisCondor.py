...
parser.add_argument( "-f", "--normFile", type = str, dest = "normFile", default = os.path.expandvars("${SourceArea}/VBFAnalysis/data/f_out_total_v05.root"), help = "file with the total number of event processed" )
...
sys = VBFAnalysis.systematics.systematics(args.syst)
